public class SimpleQueue {
    public static void Run() {
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Enqueue was inserting values at index 0, causing LIFO behavior (stack) 
        // instead of FIFO queue behavior.
        ...
        // Defect(s) Found: Dequeue threw InvalidOperationException instead of IndexOutOfRangeException, 
        // causing the expected exception not to be caught.
    }
    ...
    {
        _queue.Add(value);   // FIX #1: add to end (FIFO)
    }
    ...
    {
        if (_queue.Count == 0)
            throw new IndexOutOfRangeException(); // FIX #2: correct exception type
